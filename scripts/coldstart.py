...
sql="USE ernests_villa;"+\
    ...
    "CREATE TABLE IF NOT EXISTS unpaid_purchases (id INT PRIMARY KEY AUTO_INCREMENT,purchaseId INT,customerAccount VARCHAR(50),sellerAccount VARCHAR(50),itemId INT,count INT, paymentCents INT,consigneeAddress VARCHAR(500),consigneeName VARCHAR(50),consigneePhoneNumber VARCHAR(20), createTime BIGINT, expireTime BIGINT, INDEX (customerAccount(10)),INDEX (expireTime),INDEX(purchaseId));"+\
    "CREATE TABLE IF NOT EXISTS purchases (id INT PRIMARY KEY AUTO_INCREMENT,purchaseId INT,customerAccount VARCHAR(50),sellerAccount VARCHAR(50),itemId INT,count INT, paymentCents INT,consigneeAddress VARCHAR(500),consigneeName VARCHAR(50),consigneePhoneNumber VARCHAR(20), purchaseTime BIGINT, INDEX(itemId), INDEX (customerAccount(10)), INDEX (sellerAccount(10)),INDEX(purchaseId));"+\
